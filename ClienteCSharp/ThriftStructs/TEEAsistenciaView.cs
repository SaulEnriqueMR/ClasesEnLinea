...
namespace ThriftStructs
{
    ...
    [Serializable]
#endif
    public partial class TEEAsistenciaView : TBase
    {
        ...
        public void Write(TProtocol oprot)
        {
            ...
            try
            {
                TStruct struc = new TStruct("TEEAsistenciaView");
        ...
        {
            StringBuilder __sb = new StringBuilder("TEEAsistenciaView(");
            bool __first = true;
            if (__isset.idEEImpartida)
            {
